...
class _RoomsPageState extends ConsumerState<RoomsPage> {
  ...
  Widget buildAdminList() {
    ...
    var allHostels =
        ref.watch(hostelsFilterProvider).items.where(
          (elemet)=>elemet.managerId==ref.watch(userProvider).id
        )
        .map((e) => e.name).toList();
        ...
        Row(
          children: [
            ...
            if (styles.largerThanMobile ||
                (styles.isMobile && ref.watch(isSearchingRoomDashboardProvider)))
              SizedBox(
                ...
                child: CustomTextFields(
                  ...
                  suffixIcon: styles.isMobile
                      ? IconButton(
                          ...
                          onPressed: () {
                            ref.read(isSearchingRoomDashboardProvider.notifier).state = false;
                            ref
            ...
            if (styles.isMobile && !ref.watch(isSearchingRoomDashboardProvider))
              IconButton(
                ...
                onPressed: () {
                  ref.read(isSearchingRoomDashboardProvider.notifier).state = true;
                },
              ),
          ],
        ),
                  ...
                  label: Row(
                    ...
                    children: [
                      Text(ref.watch(selectedHostelProvider).isEmpty?
                        'Hotel Name'.toUpperCase():ref.watch(selectedHostelProvider)),
                      ...
                      PopupMenuButton(
                          ...
                          onSelected: (value) {
                            ref.read(selectedHostelProvider.notifier).state = value;
                            ref
                                .read(roomsFilterProvider.notifier)
